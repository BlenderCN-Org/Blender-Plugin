...
def create_3d_text_material():
    ...
    node.inputs['Color'].default_value = [1, 0, 0, 0]
...
def create_plane_material():
    ...
    diffuse_shader.inputs['Color'].default_value = [0.0, 0.3, 1, 1]
    diffuse_shader.inputs['Roughness'].default_value = 0.0

    glass_shader = nodes.new(type='ShaderNodeBsdfGlass')
    glass_shader.inputs['Color'].default_value = [0.16, 0.16, 0.16, 0]
